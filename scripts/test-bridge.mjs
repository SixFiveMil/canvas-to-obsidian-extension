...
/**
 * Canvas to Obsidian Extension - Bridge Listener Diagnostics Script
 *
 * Verifies that the Obsidian plugin HTTP bridge is up, running, and accepting requests from the browser extension.
 * Usage:
...
console.log(`\n======================================================`);
console.log(`  Canvas Sync Bridge Listener Diagnostic`);
